...
class BannerAddPage(models.Model):
	...
	ad_url1=models.URLField(max_length=200,blank=True,null=True)
	ad_banner2=models.ImageField(upload_to=upload_to1,blank=True,null=True)
	ad_url2=models.URLField(max_length=200,blank=True,null=True)
	ad_banner3=models.ImageField(upload_to=upload_to1,blank=True,null=True)
	ad_url3=models.URLField(max_length=200,blank=True,null=True)
